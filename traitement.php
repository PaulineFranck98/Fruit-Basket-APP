<?php
    ...
    // -> la condition sera vraiment si la requête POST transmet bien une clé "submit" au serveur
    
    if(isset($_POST['submit'])){

        //supprime dans chaîne de caractèresles caractères spéciaux et toutes balises HTML potentielles ou les encode -> pas d'injectionde code HTML possible
